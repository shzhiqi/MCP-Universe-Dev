...
def verify(notion: Client, main_id: str = None) -> tuple[bool, str]:
    ...
    if len(column_children) < 2:
        ...
        return False, f"Error: Column list should have at least 2 columns, found {len(column_children)}."
    ...
    if link_to_page_count < 2:
        ...
        return False, f"Error: Tools column should have at least 2 link_to_page blocks, found {link_to_page_count}."
    ...
    for i in range(0, roles_index if roles_index else len(all_blocks)):
        ...
        if block.get("type") == "heading_2":
            ...
            if heading_text == "Terminologies":
                ...
                return False, "Error: 'Terminologies' section found before 'Roles & responsibilities'."
