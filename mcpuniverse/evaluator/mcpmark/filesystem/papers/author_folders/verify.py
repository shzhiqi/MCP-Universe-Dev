        ...
        if item.is_dir():
            ...
            if dir_name not in frequent_authors:
                ...
                if dir_name in author_papers and len(author_papers[dir_name]) < 4:
                    ...
                    return False, f"Author {dir_name} has only {len(author_papers[dir_name])} papers but has a folder in frequent_authors"
        ...
        if item.is_dir():
            ...
            if dir_name not in prolific_2025_authors:
                ...
                if dir_name in author_2025_papers and len(author_2025_papers[dir_name]) < 3:
                    ...
                    return False, f"Author {dir_name} has only {len(author_2025_papers[dir_name])} papers in 2025 but has a folder in 2025_authors"
    ...
    for author_dir in frequent_authors_dir.iterdir():
        if author_dir.is_dir():
            ...
            if not re.match(r'^[a-z0-9_]+$', name):
                ...
                return False, f"Invalid folder name in frequent_authors: {name} (should be lowercase with underscores)"
    ...
    for author_dir in authors_2025_dir.iterdir():
        if author_dir.is_dir():
            ...
            if not re.match(r'^[a-z0-9_]+$', name):
                ...
                return False, f"Invalid folder name in 2025_authors: {name} (should be lowercase with underscores)"
