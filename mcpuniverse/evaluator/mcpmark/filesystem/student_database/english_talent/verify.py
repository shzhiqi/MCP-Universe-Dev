    ...
    try:
        ...
        while current_line < len(lines):
            ...
            if not lines[current_line].strip().startswith("name: "):
                ...
                return False, f"Invalid name line format at line {current_line + 1}"
            ...
            if not lines[current_line + 1].strip().startswith("id: "):
                ...
                return False, f"Invalid id line format at line {current_line + 2}"
            ...
            if not lines[current_line + 2].strip().startswith("email: "):
                ...
                return False, f"Invalid email line format at line {current_line + 3}"
