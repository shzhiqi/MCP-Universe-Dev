        ...
        for file_path in dir_path.iterdir():
            if file_path.is_file():
                ...
                if dir_name == "small_files" and file_size >= 300:
                    ...
                    return False, f"File {file_path.name} in small_files but size is {file_size} bytes"
                    ...
                    return False, f"File {file_path.name} in medium_files but size is {file_size} bytes"
                elif dir_name == "large_files" and file_size <= 700:
                    print(f"❌ File {file_path.name} in large_files but size is {file_size} bytes")
                    return False, f"File {file_path.name} in large_files but size is {file_size} bytes"
