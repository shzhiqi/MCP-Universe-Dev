...
def verify_analysis_format(test_dir: Path) -> tuple:
    ...
    try:
        ...
        while line_index < len(lines):
            ...
            if not re.search(r'\d+', count_line):
                ...
                return False, f"Count line doesn't contain a number at line {line_index + 2}"
...
def verify_required_categories(test_dir: Path) -> tuple:
    ...
    try:
        ...
        return False, f"Error verifying required categories: {e}"

def verify_category_counts(test_dir: Path) -> tuple:
    ...
    try:
        ...
        for category, expected_count in expected_counts.items():
            if category in category_counts:
                ...
                if actual_count != expected_count:
                    ...
                    return False, f"Count mismatch for {category}: expected {expected_count}, got {actual_count}"
            else:
        ...
        return False, f"Error verifying category counts: {e}"
