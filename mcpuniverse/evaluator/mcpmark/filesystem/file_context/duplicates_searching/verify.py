    ...
    for group_name, files in expected_duplicate_groups.items():
        ...
        for filename in files[1:]:
            ...
            if file_hash != first_hash:
                ...
                return False, f"Files in group {group_name} have different content: {files[0]} vs {filename}"
...
def verify_total_file_count(test_dir: Path) -> tuple:
    ...
    if actual_duplicates != expected_duplicates:
        ...
        return False, f"Wrong number of files in duplicates directory. Expected: {expected_duplicates}, Actual: {actual_duplicates}"
